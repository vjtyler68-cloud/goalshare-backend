...
exports.sendLinkViaMail = exports.sendOtpViaMail = exports.sendEmail = void 0;
...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f6f9fc; margin: 0; padding: 0; line-height: 1.6;">
    ...
    yield (0, exports.sendEmail)(to, html, 'Quirpleb: Verification OTP');
});
exports.sendOtpViaMail = sendOtpViaMail;
const sendLinkViaMail = (to, link) => __awaiter(void 0, void 0, void 0, function* () {
    const html = `<!DOCTYPE html> 
<html lang="en"> 
<head> 
  <meta charset="UTF-8" /> 
...
<body style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: linear-gradient(135deg, #f8faf8 0%, #e8f4f0 100%); margin: 0; padding: 40px 20px; line-height: 1.6;"> 
  ...
  <style>
    ...
    yield (0, exports.sendEmail)(to, html, 'Overlanding Outpost: Verify Your Account');
});
exports.sendLinkViaMail = sendLinkViaMail;
